...
import photoBg from '../../../assets/images/yellow-bg2.svg'
      ...
      <Container>
        <FlexWrapper align={"center"} justify={"space-between"} wrap={"wrap-reverse"}>
          <Box>
            ...
            <Link href=""><Button border={"2px solid #1abcfe"}>Projects</Button></Link>
            <Link href=""><Button border={"2px solid #25282B"}>LinkedIn</Button></Link>
          </Box>
          <PhotoWrapper>
            <Photo src={photo} alt="" />
          </PhotoWrapper>
